...
This code base is a part of e-learning course [How to Build a Crowd Sale (ICO) App in Ethereum Blockchain](https://www.toshacademy.com/courses/how-to-build-a-crowd-sale-ico-app-in-ethereum-blockchain?utm_source=github&utm_medium=ico-app-repo) hosted at [Tosh Academy](https://www.toshacademy.com/collections/blockchain?utm_source=github&utm_medium=ico-app-repo). 

Learn how to build ICOs using smart contracts.
...
```
$ cd build-ico-app-in-ethereum-solidity
```
